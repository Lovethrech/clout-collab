...
const roles = [
  {
    ...
    emoji: '🎥',
    label: 'Creator',
    desc: 'Content, video, photo & more'
  },
  {
    value: 'musician',
    emoji: '🎤',
    label: 'Musician',
    desc: 'Artists, producers, DJs'
  },
  {
    value: 'brand',
    emoji: '🏢',
    label: 'Brand',
    desc: 'Companies & campaigns'
  },
  {
    value: 'creative_professional',
    emoji: '🎨',
    label: 'Creative Professional',
    desc: 'Editors, designers, etc.'
  }
]
  ...
  <div class="auth-role dsp-flex-jstf-center-plc-center">
    <div class="auth-role-main-ctn">
      ...
      <div class="role-list">
        ...
        >
          <div
            class="role-icon dsp-flex-jstf-center-plc-center"
          ...
          <div
            ...
            :class="{ 'role-check-empty': selectedRole !== role.value }"
          >
