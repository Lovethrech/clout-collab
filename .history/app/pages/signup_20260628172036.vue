...
const finalizeSignUp = async (selectedRole) => {
  ...
  try {
    ...
    /*
      ...
      In that case, we can safely create/repair the profile row from the frontend.
    */
    if (session) {
    ...
    /*
      ...
      The SQL trigger should create the profile row.
      User must confirm email, then login.
    */
