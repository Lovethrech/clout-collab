...
const roleOptions = {
    ...
    brand: {
        ...
        skills: ['Campaign planning','Influencer marketing','Social media strategy','Brand management','Content briefing','Paid ads','Community engagement','Analytics reporting',
