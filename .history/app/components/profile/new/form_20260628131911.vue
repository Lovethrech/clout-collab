        ...
        <form class="profile-new-user-form">
            ...
            <div class="profile-new-user-form-input-and-label-field-ctn">
                <div class="profile-new-user-form-input-and-label-field">
                    ...
                    <input v-model="fullName" type="text" id="fullName" class="profile-new-user-form-input" placeholder="John Doe"/>
                </div>
                <div class="profile-new-user-form-input-and-label-field">
                    <label for="bio" class="profile-new-user-form-label">Bio:</label>
                    <textarea v-model="bio" type="text" id="bio" class="profile-new-user-form-input" placeholder="Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum, perferendis..."></textarea>
                </div>
                <div class="profile-new-user-form-input-and-label-field">
