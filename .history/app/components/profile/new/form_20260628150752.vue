...
const roleOptions = {
    ...
    skills: ['Short-form video editing','Long-form video editing','Scriptwriting','Content strategy','Photography','Videography','Community management','Brand storytelling','Canva design',
        'CapCut editing'
    ]
    },
