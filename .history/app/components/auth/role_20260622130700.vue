                ...
                <div class="role-card selected">
                    <div class="role-icon">
                        <svg viewBox="0 0 48 48">
                            <rect x="4" y="14" width="40" height="26" rx="7" fill="none" stroke="#fff" stroke-width="3"/>
                            <circle cx="24" cy="27" r="8" fill="none" stroke="#fff" stroke-width="3"/>
                ...
                <div class="role-card">
                    <div class="role-icon">
                        <svg viewBox="0 0 48 48">
                            ...
                            <rect x="18" y="10" width="12" height="9" rx="3" fill="none" stroke="#94A3B8" stroke-width="3"/><line x1="6" y1="28" x2="42" y2="28" stroke="#94A3B8" stroke-width="2.5"/></svg></div>
