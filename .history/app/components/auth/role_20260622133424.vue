        ...
        <div class="auth-role-main-ctn">
            ...
            <div class="role-list">
                <div class="role-card selected">
                    <div class="role-icon"> <svg viewBox="0 0 48 48"> <rect x="4" y="14" width="40" height="26" rx="7" fill="none" stroke="#fff" stroke-width="3"/> <circle cx="24" cy="27" r="8" fill="none" stroke="#fff" stroke-width="3"/> <rect x="16" y="8" width="10" height="7" rx="2" fill="#fff"/></svg>
                    </div>
