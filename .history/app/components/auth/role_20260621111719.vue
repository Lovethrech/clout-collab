<template>
    <div class="auth-role">
        ...
        <div class="scr-h1" style="margin-top:18px;">What brings you here?</div>
...
.back{ 
    width:30px; height:30px; border-radius:50%; background:var(--slate-800); display:flex; align-items:center; justify-content:center; font-size:14px; color:var(--slate-400); }
