            ...
            <div class="role-list">
                ...
                <div class="role-card">
                    <div class="role-icon dsp-flex-jstf-center-plc-center">
                        <svg viewBox="0 0 48 48"><rect x="6" y="18" width="36" height="22" rx="4" fill="none" stroke="#94A3B8" stroke-width="3"/><rect x="18" y="10" width="12" height="9" rx="3" fill="none" stroke="#94A3B8" stroke-width="3"/>
